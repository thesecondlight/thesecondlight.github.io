...
var _1c=[];
var _1d=this.groups;
for(var i=0;i<_1d.length;i++){ _1c.push(this.rendergroup.call(this,_19,i,_1d[i],_1b)); } $(_1a).html(_1c.join("")); },rendergroup:function(_1e,_1f,_20,_21){ var _22="$.data(_1e," datagrid");" _23="_22.options;" _24="$(_1e).datagrid(" getcolumnfields",_21);" _25="[];" _25.push("<div class="\" datagrid-group\"" group-index="+_1f+">");
...
_25.push("");
_25.push("<table class="\" datagrid-btable\"" cellspacing="\" 0\"" cellpadding="\" border="\"><tbody>");
var _26=_20.startIndex;
for(var j=0;j<_20.rows.length;j++){ var css="_23.rowStyler?_23.rowStyler.call(_1e,_26,_20.rows[j]):" ";" _27 ; _28 if(typeof }else{ if(css){ } cls="class=\" datagrid-row "+(_26%2&&_23.striped?"datagrid-row-alt ":" ")+_27+"\""; _29="_28?" style="\""+_28+"\"":"";"" _2a="_22.rowIdPrefix+" -"+(_21?1:2)+"-"+_26;" _25.push("<tr id="\" "+_2a+"\"" datagrid-row-index="\" "+_26+"\"" "+cls+" "+_29+">");
_25.push(this.renderRow.call(this,_1e,_24,_21,_26,_20.rows[j]));
_25.push("");
_26++;
}
_25.push("</_20.rows.length;j++){></tbody></table>");
return _25.join("");
...
_35();
var _36=[];
for(var i=0;i<_32.length;i++){ var row="_32[i];" _37="_38(row[_34.groupField]);" if(!_37){ _36.push(_37); }else{ _37.rows.push(row); } _39="0;" _3a="[];" for(var i="0;i<_36.length;i++){" _37.startindex="_39;" _39+="_37.rows.length;" _33.data.rows="_3a;" this.groups="_36;" _3b="this;" settimeout(function(){ _3b.bindevents(_31); },0); function _38(_3c){ _3d="_36[i];" if(_3d.value="=_3c){" return _3d; null; }; _35(){ if(!$("#datagrid-group-style").length){ $("head").append("<style id="\" datagrid-group-style\"">"+".datagrid-group{height:"+_34.groupHeight+"px;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;}"+".datagrid-group-title,.datagrid-group-expander{display:inline-block;vertical-align:bottom;height:100%;line-height:"+_34.groupHeight+"px;padding:0 4px;}"+".datagrid-group-expander{width:"+_34.expanderWidth+"px;text-align:center;padding:0}"+".datagrid-row-expander{margin:"+Math.floor((_34.groupHeight-16)/2)+"px 0;display:inline-block;width:16px;height:16px;cursor:pointer}"+"");
}
};
}});
...
for(var i=0;i<this.groups.length;i++){ if(this.groups[i].value="=row[_4f.groupField]){" _50="this.groups[i];" _51="i;" break; } if(_50){ if(_4d="=undefined||_4d==null){" _4d="_4e.data.rows.length;" if(_4d<_50.startindex){ }else{>_50.startIndex+_50.rows.length){
...
for(var i=_64+1;i</this.groups.length;i++){></_32.length;i++){></_1d.length;i++){>