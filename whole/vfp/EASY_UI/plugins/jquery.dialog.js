...
var _5=$("<div class="\" dialog-toolbar\""><table cellspacing="\" 0\"" cellpadding="\"><tr></tr></table></div>").appendTo(_4);
var tr=_5.find("tr");
for(var i=0;i<_3.toolbar.length;i++){ var _6="_3.toolbar[i];" if(_6="=" -"){" $("<td><div class="\" dialog-tool-separator\""></div>").appendTo(tr);
}else{
...
for(var i=0;i<_3.buttons.length;i++){ var p="_3.buttons[i];" _9="$(" <a" href="\" javascript:;\"">").appendTo(_8);
if(p.handler){
...
</_3.buttons.length;i++){></_3.toolbar.length;i++){>