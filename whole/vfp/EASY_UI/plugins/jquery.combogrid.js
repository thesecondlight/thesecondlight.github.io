...
function _43(_45,q){
for(var i=0;i<_45.length;i++){ var row="_45[i];" if((row[_3e.textfield]||"").tolowercase()="=q.toLowerCase()){" vv.push(row[_3e.idfield]); return i; } -1; }; function _40(vv){ if(!_3e.reversed){ _20(_3c,vv,true); _46(_47){ _48="$.data(_47," combogrid");" _49="_48.options;" _4a="_48.grid;" tr="_49.finder.getTr(_4a[0],null," highlight");" _48.remaintext="false;" if(tr.length){ _4b="parseInt(tr.attr(" datagrid-row-index"));" if(_49.multiple){ if(tr.hasclass("datagrid-row-selected")){ _4a.datagrid("unselectrow",_4b); }else{ _4a.datagrid("selectrow",_4b); vv="[];" $.map(_4a.datagrid("getselections"),function(row){ vv.push(row[_49.idfield]); }); $.map(_49.unselectedvalues,function(v){ if($.easyui.indexofarray(_49.mappingrows,_49.idfield,v)>=0){
