...
var _4=_3.options;
var bb=_3.bb={};
var _5=$(_2).addClass("pagination").html("<table cellspacing="\" 0\"" cellpadding="\" border="\"><tr></tr></table>");
var tr=_5.find("tr");
...
for(var _7=0;_7<aa.length;_7++){ var _8="aa[_7];" if(_8="=" list"){" ps="$(" <select" class="\" pagination-page-list\"">");
ps.bind("change",function(){
_4.pageSize=parseInt($(this).val());
_4.onChangePageSize.call(_2,_4.pageSize);
_10(_2,_4.pageNumber);
});
for(var i=0;i<_4.pagelist.length;i++){ $("<option>").text(_4.pageList[i]).appendTo(ps);
}
...
for(var i=0;i<_4.buttons.length;i++){ var _b="_4.buttons[i];" if(_b="=" -"){" $("<td><div class="\" pagination-btn-separator\""></div>").appendTo(tr);
}else{
...
if(_18.pageNumber<1){ _18.pagenumber="1;" } if(_18.pagenumber>_19){
_18.pageNumber=_19;
}
if(_18.total==0){
_18.pageNumber=0;
...
if(_1a<1){ _1a="1;" } var _1b="_1a+_18.links-1;" if(_1b>_19){
_1b=_19;
}
_1a=_1b-_18.links+1;
if(_1a<1){ _1a="1;" } for(var i="_1a;i<=_1b;i++){" var a="$(" <a" class="\" pagination-link\"" href="\" javascript:;\"">").appendTo(td);
...
if(_32.pageNumber</1){></1){></1){></_4.buttons.length;i++){></_4.pagelist.length;i++){></aa.length;_7++){>