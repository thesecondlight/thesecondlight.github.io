...
var _11=_c.edge;
if(e.pageY>_e.top&&e.pageY<_e.top+_11){ _d+="n" ; }else{ if(e.pagey<_e.top+_10&&e.pagey>_e.top+_10-_11){
_d+="s";
}
}
if(e.pageX>_e.left&&e.pageX<_e.left+_11){ _d+="w" ; }else{ if(e.pagex<_e.left+_f&&e.pagex>_e.left+_f-_11){
_d+="e";
}
}
...
for(var i=0;i<_d.length;i++){ var _13="$.inArray(_d.substr(i,1),_12);" if(_13>=0){
return _12[_13];
}
}
return "";
...
</_d.length;i++){></_e.left+_11){></_e.top+_11){>