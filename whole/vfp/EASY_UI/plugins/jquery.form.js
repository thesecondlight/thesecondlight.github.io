...
if(_2f.length){
for(var i=0;i<_23.fieldtypes.length;i++){ var _30="_23.fieldTypes[i];" _31="_2f.data(_30);" if(_31){ if(_31.options.multiple||_31.options.range){ _2f[_30]("setvalues",val); }else{ _2f[_30]("setvalue",val); } return true; false; }; function _32(_33){ $("input,select,textarea",_33).each(function(){ if($(this).hasclass("textbox-value")){ return; t="this.type,tag=this.tagName.toLowerCase();" if(t="=" text"||t="="hidden"||t=="password"||tag=="textarea"){"" this.value ; _34="$(this);" if(!_34.hasclass("textbox-value")){ _35="_34.clone().val(" ");" _35.insertafter(_34); if(_34.data("validatebox")){ _34.validatebox("destroy"); _35.validatebox(); _34.remove(); this.checked="false;" if(tag="=" select"){" this.selectedindex="-1;" }); tmp="$();" _36="$(_33);" _37="$.data(_33," form").options;" for(var i="0;i<_37.fieldTypes.length;i++){" _38="_37.fieldTypes[i];" _39="_36.find(" ."+_38+"-f").not(tmp);" if(_39.length&&_39[_38]){ _39[_38]("clear"); _36.form("validate"); _3a(_3b){ _3b.reset(); _3c="$(_3b);" _3d="$.data(_3b,">=0;i--){
