...
if(_a.length){
if(_a.position().top<=0){ var h="_9.scrollTop()+_a.position().top;" _9.scrolltop(h); }else{ if(_a.position().top+_a.outerheight()>_9.height()){
...
var _26=null;
var vv=[],ss=[];
for(var i=0;i<_21.length;i++){ var v="_21[i];" s="v;" row="_23.finder.getRow(_20,v);" if(row){ _26="row;" el="_23.finder.getEl(_20,v);" if(!el.hasclass("combobox-item-selected")){ el.addclass("combobox-item-selected"); _23.onselect.call(_20,row); } }else{ vv.push(v); ss.push(s); if(!_22){ $(_20).combo("settext",ss.join(_23.separator)); if(_23.showitemicon){ tb="$(_20).combobox(" textbox");" tb.removeclass("textbox-bgicon "+_23.textboxiconcls); if(_26&&_26.iconcls){ tb.addclass("textbox-bgicon "+_26.iconcls); _23.textboxiconcls="_26.iconCls;" $(_20).combo("setvalues",vv); _24.triggerhandler("scroll"); function _27(_28,a){ _29="$.easyui.getArrayItem(a,_23.valueField,_28);" return _29?_29[_23.textfield]:undefined; }; _2a(_2b,_2c,_2d){ _2e="$.data(_2b," combobox");" _2f="_2e.options;" _2e.data="_2f.loadFilter.call(_2b,_2c);" _2f.view.render.call(_2f.view,_2b,$(_2b).combo("panel"),_2e.data); vv="$(_2b).combobox(" getvalues");" $.easyui.foreach(_2e.data,false,function(row){ if(row["selected"]){ $.easyui.addarrayitem(vv,row[_2f.valuefield]+""); }); if(_2f.multiple){ _19(_2b,vv,_2d); _19(_2b,vv.length?[vv[vv.length-1]]:[],_2d); _2f.onloadsuccess.call(_2b,_2c); _30(_31,url,_32,_33){ _34="$.data(_31," combobox").options;" if(url){ _34.url="url;" _32="$.extend({},_34.queryParams,_32||{});" if(_34.onbeforeload.call(_31,_32)="=false){" return; _34.loader.call(_31,_32,function(_35){ _2a(_31,_35,_33); },function(){ _34.onloaderror.apply(this,arguments); _36(_37,q){ _38="$.data(_37," _39="_38.options;" _3a="$();" qq="_39.multiple?q.split(_39.separator):[q];" if(_39.mode="=" remote"){" _3b(qq); _30(_37,null,{q:q},true); _3c="$(_37).combo(" panel");" _3c.find(".combobox-item-hover").removeclass("combobox-item-hover"); _3c.find(".combobox-item,.combobox-group").hide(); _3d="_38.data;" $.map(qq,function(q){ q="$.trim(q);" _3e="q;" _3f="undefined;" for(var i="0;i<_3d.length;i++){" if(_39.filter.call(_37,q,row)){ g="row[_39.groupField];" _40="_39.finder.getEl(_37,v).show();" if(s.tolowercase()="=q.toLowerCase()){" if(_39.reversed){ _13(_37,v,true); if(_39.groupfield&&_3f!="g){" _39.finder.getgroupel(_37,g).show(); vv.push(_3e); _3b(vv); _3b(vv){ _3a.addclass("combobox-item-hover"); _19(_37,_39.multiple?(q?vv:[]):vv,true); _41(_42){ t="$(_42);" _43="t.combobox(" options");" _44="t.combobox(" _45="_44.children(" div.combobox-item-hover");" if(_45.length){ _45.removeclass("combobox-item-hover"); _46="row[_43.valueField];" if(_43.multiple){ if(_45.hasclass("combobox-item-selected")){ t.combobox("unselect",_46); t.combobox("select",_46); $.map(t.combobox("getvalues"),function(v){ if(_1(_42,v)>=0){
vv.push(v);
}
});
...
var dd=[];
var _7a=undefined;
for(var i=0;i<_77.length;i++){ var row="_77[i];" v="row[_79.valueField]+" ";" s="row[_79.textField];" g="row[_79.groupField];" if(g){ if(_7a!="g){" _7a="g;" _78.groups.push({value:g,startindex:i,count:1}); dd.push("<div id="\" "+(_78.groupidprefix+"_"+(_78.groups.length-1))+"\"" class="\" combobox-group\"">");
...
</_77.length;i++){></0&&_5a.position().top></_21.length;i++){></=0){>