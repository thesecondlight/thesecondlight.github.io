...
var _12=$("<div class="\" datebox-button\""><table cellspacing="\" 0\"" cellpadding="\" style="\" width:100%\""><tr></tr></table></div>").appendTo(_11);
var tr=_12.find("tr");
for(var i=0;i<_4.buttons.length;i++){ var td="$(" <td">").appendTo(tr);
